...
/*    @Bean
    ...
    public CacheManager cacheManager() { 
        ...
        RedisCacheManager cacheManager = new RedisCacheManager(redisCacheWriter, RedisCacheConfiguration.defaultCacheConfig().entryTtl(Duration.ofMinutes(10)));
        return cacheManager;  
    }  
    ...
    class DataJedisProperties{
        ...
        JedisConnectionFactory jedisConnectionFactory() {
            ...
            JedisConnectionFactory factory = new JedisConnectionFactory(getRedisStandaloneConfiguration());
            return factory;
        }
        @Bean
